  ...
  return (
    <Fragment>
            ...
            <>
              ...
              >
                <div className="flex items-center gap-2">
                  <div className="flex group lg:justify-center items-center p-3 bg-secondary rounded-full ">
                    <i className="icon-calendrier text-dark-shade"></i>
                  </div>
                  <div className="">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div className="flex group lg:justify-center items-center p-3 rounded-full bg-secondary ">
                    <i className="icon-calendrier text-dark-shade"></i>
                  </div>
                </div>
              </Popover.Button>
              ...
              >
                <Popover.Panel className="absolute w-[30rem] ltr:right-[calc(50%-15rem)] rtl:left-[calc(50%-15rem)] bg-white shadow-md p-2.5 lg:p-5 top-20 rounded-xl">
      ...
      <div
        ...
        className={`lg:hidden w-full flex flex-col   gap-4  lg:p-5 cursor-pointer `}
      >
        <div className="flex items-center gap-2">
          <div className="flex  justify-start items-center p-3 bg-secondary rounded-full ">
            <i className="icon-calendrier text-dark-shade"></i>
          </div>
